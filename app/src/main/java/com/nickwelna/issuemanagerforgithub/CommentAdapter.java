                ...
                if (comment instanceof Comment) {
                    ...
                    itemView.setOnLongClickListener(new OnLongClickListener() {
                        ...
                        public boolean onLongClick(View v) {
                            ...
                            new AlertDialog.Builder(context).setTitle(R.string.delete_comment_title)
                                                            .setPositiveButton(
                                                                    ...
                                                                    new DialogInterface.OnClickListener() {
                                                                        ...
                                                                        public void onClick(
                                                                            ...
                                                                            GitHubService service = ServiceGenerator
                                                                                    .createService(
                                                                                            token);
                                                                            String[] repoNameSplit = repositoryName
                                                                                    .split("/");
                                    ...
                                    R.string.no_button_text, new DialogInterface.OnClickListener() {
