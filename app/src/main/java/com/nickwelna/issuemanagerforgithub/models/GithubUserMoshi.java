...
public class GithubUserMoshi implements Parcelable {
    ...
    public GithubUserMoshi() {
    }

    protected GithubUserMoshi(Parcel in) {
    ...
    public static final Parcelable.Creator<GithubUserMoshi> CREATOR = new Parcelable.Creator<GithubUserMoshi>() {
        @Override
        public GithubUserMoshi createFromParcel(Parcel source) {
            return new GithubUserMoshi(source);
        }

        @Override
        public GithubUserMoshi[] newArray(int size) {
            return new GithubUserMoshi[size];
        }
    };
}
